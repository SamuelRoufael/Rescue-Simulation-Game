...
public class Simulator implements WorldListener {
	...
	public void nextCycle() throws CitizenAlreadyDeadException, BuildingAlreadyCollapsedException, CannotTreatException {
	...
	private void handleGas(Disaster d) throws BuildingAlreadyCollapsedException, CitizenAlreadyDeadException, CannotTreatException {
	...
	private void handleFire(Disaster d) throws CitizenAlreadyDeadException, BuildingAlreadyCollapsedException, CannotTreatException {
		ResidentialBuilding b = (ResidentialBuilding) d.getTarget();
		if (b.getGasLevel() == 0) {
				d.strike();
			executedDisasters.add(d);
